...
export const useProductStore = defineStore('product', () => {
  ...
  const filters = reactive({
    ...
    pdd_match_count_min: undefined,
    pdd_match_count_max: undefined,
    alibaba1688_matched: undefined,
    alibaba1688_match_count_min: undefined,
    alibaba1688_match_count_max: undefined,
    primary_match_score_min: undefined,
    primary_match_score_max: undefined,
